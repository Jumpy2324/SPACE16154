...
function controlRow(a,b,c){
  const note=a==="Pressione alta"
    ? info("Pressione alta","Misura quanto spesso e quanto efficacemente la squadra recupera palla con pressione alta, soprattutto nell’ultimo terzo di campo. Tiene conto anche di dove avviene il recupero e del contesto dell’avversario.")
    : "";
