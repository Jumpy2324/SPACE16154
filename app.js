...
function controlRow(a,b,c){const note=a==="Pressione alta"?`<small>Più alto indica maggiore intensità di pressione e capacità di disturbare la costruzione avversaria.</small>`:"";return `<div class="control-row"><span>${a}${note}</span><b>${b}</b><b>${c}</b></div>`;}
